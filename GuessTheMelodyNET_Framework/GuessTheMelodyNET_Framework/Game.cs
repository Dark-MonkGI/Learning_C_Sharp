...
namespace GuessTheMelodyNET_Framework
{
    public partial class fGame : Form
    {
        ...
        private void fGame_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                GamePause();
                if (MessageBox.Show("Is the answer correct?", "Player One", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
            ...
            {
                GamePause();
                if (MessageBox.Show("Is the answer correct?", "Player Two", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
